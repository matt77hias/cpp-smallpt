...
namespace smallpt {
	...
	inline Vector3 UniformSampleOnSphere(double u1, double u2) noexcept {
	...
	inline Vector3 UniformSampleOnHemisphere(double u1, double u2) noexcept {
		// u1 := cos_theta
	...
	inline Vector3 CosineWeightedSampleOnHemisphere(double u1, double u2) noexcept {
