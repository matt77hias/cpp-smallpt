...
namespace smallpt {
	...
	[[nodiscard]]
	inline const Vector3 UniformSampleOnSphere(double u1, 
											   double u2) noexcept {
	...
	[[nodiscard]]
	inline const Vector3 UniformSampleOnHemisphere(double u1, 
												   double u2) noexcept {
	...
	[[nodiscard]]
	inline const Vector3 CosineWeightedSampleOnHemisphere(double u1, 
														  double u2) noexcept {
